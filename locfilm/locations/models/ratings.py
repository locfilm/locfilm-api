...
class Rating(models.Model):
    ...
    accesibility = models.IntegerField(null=False, verbose_name='Accesibility of location', choices= RATINGS_CHOICES, default=1),
    conditions = models.IntegerField(null=False, verbose_name='Conditions of location', choices= RATINGS_CHOICES, default=1),
    average = models.IntegerField(null=False, verbose_name='value for money of the location', choices= RATINGS_CHOICES, default=1),
